...
import {FormElementGroup, InlineMultipleList} from './FormElement';

export default class CourseManipulatePage extends React.Component {
                ...
                <Row className="justify-content-center">
                    <Col sm={8}>
                        <Form>
                            ...
                            <FormElementGroup inputId="duration" inputName="daration" inputType="number" inputPlaceholer="Duration" labelValue="Duration"/>
